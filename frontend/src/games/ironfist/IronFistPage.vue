  ...
  <q-page class="ironfist-page">
    ...
    <div v-if="view === 'lobby'" class="q-pa-md">
      <div class="row items-center q-mb-md">
        ...
        <div class="text-caption text-grey-5 q-ml-xs">区块链技术·零作弊·公开透明</div>
        <q-space />
        <div class="text-caption text-grey-5 cursor-pointer rules-link" @click="showRules = true"><span>查看玩法</span></div>
      </div>

      <div class="mode-card mode-card--pvp">
        <div class="mode-emoji">👥</div>
        <div>
          <div class="text-subtitle1 text-bold">我的$FIST</div>
          <div class="text-caption text-grey-4">区块链账本</div>
        </div>
        <q-icon
      ...
      <div class="mode-card mode-card--pve" @click="startPve">
        ...
        <div>
          ...
          <div class="text-caption text-grey-4">每场奖励500$FIST，每天最多10场</div>
        </div>
          ...
          >
            <div class="mh-head">
              ...
              <div class="mh-id">
                ...
                <div class="mh-score">
                  <span class="mh-score-ic">⚔</span>{{ myDamage }}
                </div>
              </div>
            </div>
            <div class="mh-hpbar">
          ...
          >
            <div class="mh-head">
              ...
              <div class="mh-id mh-id--right">
                ...
                <div class="mh-score">
                  <span class="mh-score-ic">⚔</span>{{ oppDamage }}
                </div>
              </div>
            </div>
        ...
        <div v-if="showReveal" class="reveal-wrap">
          ...
          <div class="reveal">
            <div class="rv-side rv-side--me">
              ...
              <span class="rv-move">
                <span class="rv-ic">{{ actionMeta[revealMy]?.icon }}</span
            ...
            <div class="rv-side rv-side--opp">
              ...
              <span v-if="revealOpp" class="rv-move">
                <span class="rv-ic">{{ actionMeta[revealOpp]?.icon }}</span
          ...
          <button
            ...
            :class="[
              'act-btn--' + a.key,
              {
                ...
                dim: !canAct || (myAction && myAction !== a.key),
              },
            ]"
            :disabled="!canAct"
...
function spawnRipple(btn, e) {
  ...
  btn.addEventListener("animationend", () => btn.classList.remove("rippling"), {
    once: true,
  });
}
