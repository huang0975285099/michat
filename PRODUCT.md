...
| 文件传输 | 加密文件传输，支持图片/视频预览和文件下载 |
| 消息已读 | 已读/未读状态回执，双勾标识 |
| 阅后即焚 | 开启后，双方阅读 24 小时自动销毁 |
...
| 个人页 | `/profile` | 身份信息、邀请好友、私钥备份、安全码管理、账号注销 |
